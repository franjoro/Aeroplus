...
if (isset($_SESSION['session_id']) &&  $_SESSION['session_id']=='2' && $id1==$sqll[0] ) {
...
<tbody>
<?php 
$a=mysqli_query($conexion,"SELECT * FROM horas WHERE id_alumno='$id1' AND Role='3' ");
 ...
 ?>
  ...
  <div class="w3-col s3" >
    <div class="w3-container w3-card w3-white w3-round">
      ...
      <p><strong>Licencia: </strong><?php echo $text ?></p>
      <p><strong>Saldo: </strong>$<?php echo $sqll[6] ?></p>
